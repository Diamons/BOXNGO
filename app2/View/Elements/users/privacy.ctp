This Privacy Policy governs the manner in which BOX'NGO collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="http://theboxngo.com/">http://theboxngo.com/</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by BOX'NGO.<br><br>
...
BOX'NGO may collect and use Users personal information for the following purposes:<br>
<ul>
