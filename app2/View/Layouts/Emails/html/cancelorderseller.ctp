                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<img src="<?php echo $domain ?>img/email/header.png" style="max-width:600px;" id="headerImage campaign-icon" />
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div>
																...
																<p>
																	You recently received an order for the following item: <?php echo $domain."shops/viewlisting/".$variables['listing']['Shop']['id']; ?>. We regret to inform you that because you did respond to the order request, the order has been cancelled on your behalf.
																</p>
																<p>
																	<h1>Please Note</h1>
                                                        	...
                                                        	<table border="0" cellpadding="15" cellspacing="0" class="templateButton">
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div>
                                                                        	<a href="<?php echo $domain ?>" target="_blank">Visit BOX'NGO</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
