<div class="navbar">
  <div class="wrapper">
	...
	<ul class="nav navbar-nav">
		...
		<li><a href="/dashboard">Dashboard<?php if(isset($auth) && ((int)$notifications + (int)$messages) > 0){echo "<span class='notification'>".((int)$notifications + (int)$messages)."</span>";};?></a></li>
	</ul>	
		<?php if(!isset($auth)){ ?>
