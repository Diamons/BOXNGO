...
<div id="content" class="wrapper">
	<div class="row">
		...
		<div id="categories" class="col-xs-3 col-md-3">
			...
			<div class="panel panel-primary">
				...
				<div class="row">
					...
					<div class="newlyListedInfo col-xs-8 col-md-8">
			...
			<?php
			 /*<div id="featured_recent" class="row">
				<div class="col-xs-8 col-md-8">
					<div class="row">
						<div class="featured_seller col-xs-5 col-md-5">
						...
						<div class="featured_seller_info col-xs-7 col-md-7">
				...
				<div id="recent_activity" class="col-xs-4 col-md-4">
