<?php
	class ShopSearch extends AppModel{
		...
		public function saveShop($listing){
			...
			$data['ShopSearch']['name'] = htmlspecialchars($listing['Shop']['name']);
			$data['ShopSearch']['description'] = htmlspecialchars($listing['Shop']['description']);
			$data['ShopSearch']['full_url'] = $listing['Shop']['full_url'];
			$data['ShopSearch']['display_name'] = htmlspecialchars($listing['User']['display_name']);
